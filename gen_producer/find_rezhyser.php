...
<div>
<h1 align="center" class="colorForAllText">Режисери</h1></br>

</div>
<div class="noprint">

<form action="editingStaffFilmCrew.php" method="post">
...
<td  class = "noprint"><div class = "noprint">Змінити інформацію</div></td>
</tr></thead>
...
$mysqli->query("SET NAMES 'utf8'");
 $result_others = $mysqli->query("SELECT * FROM `others` WHERE `name_of_position` = 'режисер'");
 function res($result){
  $print = "";
    if($result)
    {
