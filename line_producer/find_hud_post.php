...
<head>
<meta  charset=utf-8>
<title>Знайти художників-постановщиків</title>
...
<div>
<h1 align="center" class="colorForAllText">Художники-постановщики</h1></br>
...
<td class = "noprint"><div class = "noprint">Зміна інформації художника-постановщика</div></td>
</tr></thead>
<?php
$mysqli = new mysqli("localhost","root","root","filmstudio");
$mysqli->query("SET NAMES 'utf8'");
 $result_others = $mysqli->query("SELECT * FROM `others` WHERE `name_of_position` = 'художник-постановщик'");
 function res($result){
  $print = "";
    if($result)
    {
