...
<h3 class="colorText">Додавання співробітників</h3></br>
  <form action="" method="post">
    <select name="choice" class="select selectpicker  form-control">
      <option value="staff">Співробітник знімальної групи</option>
...
if (isset($_POST['add'])){
  ...
  switch ($choice) {
    case 'staff':
        header("location: /filmStudio/line_producer/addingStaffFilmCrew.php");
        break;

    case 'editor':
        header("location: /filmStudio/line_producer/addingEditor.php");
        break;
    }
        ...
        header("location: /filmStudio/line_producer/find_others.php");
          ...
          header("location: /filmStudio/line_producer/find_others.php");
            ...
            header("location: /filmStudio/line_producer/find_others.php");
              ...
              case 'operator':
                header("location: /filmStudio/line_producer/find_operator.php");
                break;

                case 'light_director':
                  header("location: /filmStudio/line_producer/find_gafer.php");
                  break;

                  case 'sound_director':
                    header("location: /filmStudio/line_producer/find_zvukurezhiser.php");
                    break;

                    case 'costume_designer':
                      header("location: /filmStudio/line_producer/find_hud_po_kost.php");
                      break;

                      case 'production_designer':
                        header("location: /filmStudio/line_producer/find_hud_post.php");
                        break;

                        case 'actor_agent':
                          header("location: /filmStudio/line_producer/find_actors_agent.php");
                          break;
                                ...
                                header("location: /filmStudio/line_producer/find_others.php");
                                  ...
                                  header("location: /filmStudio/line_producer/find_others.php");
                                    ...
                                    header("location: /filmStudio/line_producer/find_others.php");
                                      ...
                                      case 'scene_admin':
                                        header("location: /filmStudio/line_producer/find_admin_maidanchyk.php");
                                        break;
                                            ...
                                            header("location: /filmStudio/line_producer/find_others.php");
                                              ...
                                              header("location: /filmStudio/line_producer/find_others.php");
                                                ...
                                                header("location: /filmStudio/line_producer/find_others.php");
                                                  ...
                                                  case 'editor':
                                                    header("location: /filmStudio/line_producer/find_editor.php");
                                                    break;
                                                    ...
                                                    header("location: /filmStudio/line_producer/find_movie.php");
                                                      ...
                                                      case 'filmCrew':
                                                        header("location: /filmStudio/line_producer/find_filmCrew.php");
                                                        break;
