...
<td class = "noprint"><div class = "noprint">Зміна інформації гафера</div></td>
</tr></thead>
<?php
$mysqli = new mysqli("localhost","root","root","filmstudio");
$mysqli->query("SET NAMES 'utf8'");
 $result_others = $mysqli->query("SELECT * FROM `others` WHERE `name_of_position` = 'гафер'");
 function res($result){
  $print = "";
    if($result)
    {
