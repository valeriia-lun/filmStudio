...
<head>
<meta  charset=utf-8>
<title>Знайти адміністратора майданчика</title>
...
<select  class="select selectpicker  form-control">
  <option>Найдешевший адміністратор майданчика</option>
  <option>Найдорожчий адміністратор майданчика</option>
  <option>Адміністратор майданчика з найбльшим стажем</option>
</select>
</div>
<form>
