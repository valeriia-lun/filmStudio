...
<br><br><h1 class="colorForAllText">Додати співробітника знімальної групи</h1>
...
<div class="row text-center" style="margin:10px;">
  ...
  <div class="field_wrapper_Ratings">
      <div>
      <div class=" container col-5"> <input type="text" class="form-control" name="field_name_Ratings[]" value=""/></div>
...
VALUES ('$id', '$salary', '$name', '$last_name', '$middle_name', '$address', '$work_since', '$years', '$amount_of_films','$rating',
   '$birthDate', '$place_of_birth', '$position', '$email')");
   if ($result) {
      echo "Success!";
    }
   else {
