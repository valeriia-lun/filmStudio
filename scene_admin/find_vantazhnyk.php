...
<td><div class = "noprint">Зміна інформації про вантажника</div></td>
</tr></thead>
<?php
$mysqli = new mysqli("localhost","root","root","filmstudio");
$mysqli->query("SET NAMES 'utf8'");
 $result_others = $mysqli->query("SELECT * FROM `others` WHERE `name_of_position` = 'вантажник'");
 function res($result){
  $print = "";
    if($result)
    {
