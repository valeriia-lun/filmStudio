...
echo "<input type= \"text\" maxlength=\"50\" tabindex=\"2\"  class=\"form-control\" name=\"years\" value=\"$res[0]\" required>";
    ?><br>
    </div>
  <div class=" container col-3">
...
echo "<input type= \"text\" maxlength=\"50\" tabindex=\"2\"  class=\"form-control\" name=\"salary\" value=\"$res[0]\" required>";
    ?><br></div></div>
    <div class="row">
