...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    echo"<td>" ."<input type=\"checkbox\" value = \"" . $stroka['others_id'] . "\" name=\"cooker_id[]\" >";
    echo"</tr>";
   }
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    echo"<td>" .  res($result_others_contacts_rel) . "</td>";
    echo"<td>" .  res($result_others_ratings) . "</td>";
    echo"<td>" ."<input type=\"checkbox\" value = \"" . $stroka['others_id'] . "\" name=\"driver_id[]\" >";
    echo"</tr>";
   }
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    echo"<td>" .  res($result_others_contacts_rel) . "</td>";
    echo"<td>" .  res($result_others_ratings) . "</td>";
    echo"<td>" ."<input type=\"checkbox\" value = \"" . $stroka['others_id'] . "\" name=\"vantazhnyk_id[]\" >";
    echo"</tr>";
   }
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    echo"<td>" .  res($result_others_contacts_rel) . "</td>";
    echo"<td>" .  res($result_others_ratings) . "</td>";
    echo"<td>" ."<input type=\"checkbox\" value = \"" . $stroka['others_id'] . "\" name=\"prybyralnik_id[]\" >";
    echo"</tr>";
   }
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    echo"<td>" .  res($result_others_contacts_rel) . "</td>";
    echo"<td>" .  res($result_others_ratings) . "</td>";
    echo"<td>" ."<input type=\"checkbox\" value = \"" . $stroka['others_id'] . "\" name=\"ohoronets_id[]\" >";
    echo"</tr>";
   }
...
<button  name="done">Додати обраних співробітників</button>
</form>
</body>
</html>
