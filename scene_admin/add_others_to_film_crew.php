...
<h1 align="center" class="colorForAllText">Кухарі</h1></br>
...
<form action="admin_maidanchyka_check.php" method="POST">
<?php
$mysqli = new mysqli("localhost","root","root","filmstudio");
$mysqli->query("SET NAMES 'utf8'");

// $result_others = $mysqli->query("SELECT * FROM `others` WHERE `name_of_position` = 'кухар'");
...
$result_others=$mysqli->query("SELECT * FROM others WHERE `name_of_position` = 'кухар' AND (others_id NOT IN (SELECT DISTINCT others_id FROM others_filmcrew WHERE number_of_film_crew
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    if($re[0] != ""){
      echo"<td>" ."<input type=\"checkbox\" checked class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"cooker_id[]\" >";

    }else{
      echo"<td>" ."<input type=\"checkbox\" class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"cooker_id[]\" >";
    }
...
<h1 align="center" class="colorForAllText">Водії</h1></br>
...
$result_others=$mysqli->query("SELECT * FROM others WHERE `name_of_position` = 'водій' AND (others_id NOT IN (SELECT DISTINCT others_id FROM others_filmcrew WHERE number_of_film_crew
 IN(SELECT number_of_film_crew FROM film_crew WHERE ((date_finish_film_crew BETWEEN '$used_start' AND '$used_finish') OR
(date_start_crew BETWEEN  '$used_start' AND  '$used_finish')))) OR  others_id IN (SELECT others_id FROM `others_filmcrew` WHERE number_of_film_crew = $number_of_filmCrew))");
ini_set('error_reporting', 0);
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    if($re[0] != ""){
      echo"<td>" ."<input type=\"checkbox\" checked class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"driver_id[]\" >";

    }else{
      echo"<td>" ."<input type=\"checkbox\" class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"driver_id[]\" >";
    }
...
<h1 align="center" class="colorForAllText">Вантажники</h1></br>
...
$result_others=$mysqli->query("SELECT * FROM others WHERE `name_of_position` = 'вантажник' AND (others_id NOT IN (SELECT DISTINCT others_id FROM others_filmcrew WHERE number_of_film_crew
 IN(SELECT number_of_film_crew FROM film_crew WHERE ((date_finish_film_crew BETWEEN '$used_start' AND '$used_finish') OR
(date_start_crew BETWEEN  '$used_start' AND  '$used_finish')))) OR  others_id IN (SELECT others_id FROM `others_filmcrew` WHERE number_of_film_crew = $number_of_filmCrew))");
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    if($re[0] != ""){
      echo"<td>" ."<input type=\"checkbox\" checked class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"vantazhnyk_id[]\" >";

    }else{
      echo"<td>" ."<input type=\"checkbox\" class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"vantazhnyk_id[]\" >";
    }
...
<h1 align="center" class="colorForAllText">Прибиральниці</h1></br>
...
$result_others=$mysqli->query("SELECT * FROM others WHERE `name_of_position` = 'прибиральник' AND (others_id NOT IN (SELECT DISTINCT others_id FROM others_filmcrew WHERE number_of_film_crew
 IN(SELECT number_of_film_crew FROM film_crew WHERE ((date_finish_film_crew BETWEEN '$used_start' AND '$used_finish') OR
(date_start_crew BETWEEN  '$used_start' AND  '$used_finish')))) OR  others_id IN (SELECT others_id FROM `others_filmcrew` WHERE number_of_film_crew = $number_of_filmCrew))");
...
while ($stroka = mysqli_fetch_array($result_others)){
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    if($re[0] != ""){
      echo"<td>" ."<input type=\"checkbox\" checked class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"prybyralnik_id[]\" >";

    }else{
      echo"<td>" ."<input type=\"checkbox\" class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"prybyralnik_id[]\" >";
    }
...
$result_others=$mysqli->query("SELECT * FROM others WHERE `name_of_position` = 'охоронець' AND (others_id NOT IN (SELECT DISTINCT others_id FROM others_filmcrew WHERE number_of_film_crew
 IN(SELECT number_of_film_crew FROM film_crew WHERE ((date_finish_film_crew BETWEEN '$used_start' AND '$used_finish') OR
(date_start_crew BETWEEN  '$used_start' AND  '$used_finish')))) OR  others_id IN (SELECT others_id FROM `others_filmcrew` WHERE number_of_film_crew = $number_of_filmCrew))");
while ($stroka = mysqli_fetch_array($result_others)){
  $temp = $stroka['others_id'];
  ...
  $result_others_ratings = $mysqli->query("SELECT `rating` FROM `previous_movies_rating` WHERE `id_previous_movie_rating` IN (SELECT `id_previous_movie_rating` FROM  `others_previous_movies_ratings` WHERE `others_id` = $temp)");
    ...
    if($re[0] != ""){
      echo"<td>" ."<input type=\"checkbox\" checked class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"ohoronets_id[]\" >";

    }else{
      echo"<td>" ."<input type=\"checkbox\" class=\"form-control\" value = \"" . $stroka['others_id'] . "\" name=\"ohoronets_id[]\" >";
    }
