...
<h3 class="colorText">Додавання технічних працівників</h3></br>
...
if (isset($_POST['find'])){
  ...
  switch ($choice) {
    case 'actor':
      header("location: /filmStudio/scene_admin/find_actors.php");
      break;
                                            ...
                                            header("location: /filmStudio/scene_admin/find_vantazhnyk.php");
                                              ...
                                              header("location: /filmStudio/scene_admin/find_cleaner.php");
                                                ...
                                                header("location: /filmStudio/scene_admin/find_ohoronets.php");
                                                  ...
                                                  case 'editor':
                                                  header("location: /filmStudio/scene_admin/find_editor.php");
                                                    break;

                                                    case 'movie':
                                                    header("location: /filmStudio/scene_admin/find_movie.php");
                                                      break;
                                                      ...
                                                      header("location: /filmStudio/scene_admin/find_filmCrew.php");
                                                        ...
                                                        case 'editCrew':
                                                        header("location: /filmStudio/scene_admin/find_editCrew.php");
                                                          break;
  }
}
