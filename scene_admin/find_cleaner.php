...
<head>
<meta  charset=utf-8>
<title>Знайти прибиральників</title>
...
<div>
<h1 align="center" class="colorForAllText">Прибиральники</h1></br>
...
$mysqli->query("SET NAMES 'utf8'");
 ...
 $result_others = $mysqli->query("SELECT * FROM `others` WHERE `name_of_position` = 'прибиральник'");
 function res($result){
  $print = "";
    if($result)
    {
