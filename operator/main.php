...
if (isset($_POST['find'])){
  ...
  switch ($choice) {
    case 'actor':
      header("location: /filmStudio/operator/find_actors.php");
      break;

    case 'understudy':
      header("location: /filmStudio/operator/find_understudies.php");
      break;

    case 'others':
    header("location: /filmStudio/operator/find_others.php");
      break;
                                            ...
                                            header("location: /filmStudio/operator/find_others.php");
                                              ...
                                              header("location: /filmStudio/operator/find_others.php");
                                                ...
                                                header("location: /filmStudio/operator/find_others.php");
                                                  ...
                                                  case 'editor':
                                                  header("location: /filmStudio/operator/find_editor.php");
                                                    break;

                                                    case 'movie':
                                                    header("location: /filmStudio/operator/find_movie.php");
                                                      break;

                                                      case 'filmCrew':
                                                      header("location: /filmStudio/operator/find_filmCrew.php");
                                                        break;

                                                        case 'editCrew':
                                                        header("location: /filmStudio/operator/find_editCrew.php");
                                                          break;
