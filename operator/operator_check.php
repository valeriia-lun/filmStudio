...
if ($helpers_id != '') {
        ...
        if ($result) {
           echo "</br></br></br><h1 class=\"colorForAllText\">Помічників оператора успішно додано до знімальної групи!</h1>";
         }
      else {
        echo "</br></br></br><h1 class=\"colorForAllText\">Здається, щось пішло не так..</h1>";
        echo"<form  action=\"add_helpers_to_film_crew.php\" method=\"POST\"><button class=\"btn btn-danger\">Назад</button></form>";
          }
        }
    }
}else{
