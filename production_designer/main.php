...
if (isset($_POST['find'])){
  ...
  switch ($choice) {
    case 'actor':
      header("location: /filmStudio/production_designer/find_actors.php");
      break;

    case 'understudy':
      header("location: /filmStudio/production_designer/find_understudies.php");
      break;

    case 'others':
    header("location: /filmStudio/production_designer/find_others.php");
      break;
                                            ...
                                            header("location: /filmStudio/production_designer/find_others.php");
                                              ...
                                              header("location: /filmStudio/production_designer/find_others.php");
                                                ...
                                                header("location: /filmStudio/production_designer/find_others.php");
                                                  ...
                                                  case 'editor':
                                                  header("location: /filmStudio/production_designer/find_editor.php");
                                                    break;

                                                    case 'movie':
                                                    header("location: /filmStudio/production_designer/find_movie.php");
                                                      break;

                                                      case 'filmCrew':
                                                      header("location: /filmStudio/production_designer/find_filmCrew.php");
                                                        break;

                                                        case 'editCrew':
                                                        header("location: /filmStudio/production_designer/find_editCrew.php");
                                                          break;
}
}
