...
<nav class="navbar navbar-expand-md navbar-light bg-light">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav mr-auto">
      <li class="nav-item nav-link active" ><a href="#" style="color:red;">На головну<span class="sr-only">(current)</span></a></li>
    </ul>
...
<h3 class="colorText">Додавання співробітників</h3></br>
  ...
  <option value="actor" selected>Актор</option>
  <option value="understudy">Дублер</option>
  </select><br>
  <div class="btn">
...
if (isset($_POST['add'])){
  ...
  switch ($choice) {
    case 'actor':
        header("location: /filmStudio/actor_agent/addingActor.php");
        break;

    case 'understudy':
        header("location: /filmStudio/actor_agent/addingUnderstudy.php");
        break;
    }
...
if (isset($_POST['find'])){
  ...
  switch ($choice) {
    case 'actor':
      header("location: /filmStudio/actor_agent/find_actors.php");
      break;

    case 'understudy':
      header("location: /filmStudio/actor_agent/find_understudies.php");
      break;

    case 'others':
      header("location: /filmStudio/actor_agent/find_others.php");
      break;
                                            ...
                                            header("location: /filmStudio/actor_agent/find_others.php");
                                              ...
                                              header("location: /filmStudio/actor_agent/find_others.php");
                                                ...
                                                header("location: /filmStudio/actor_agent/find_others.php");
                                                  ...
                                                  case 'editor':
                                                  header("location: /filmStudio/actor_agent/find_editor.php");
                                                    break;

                                                    case 'movie':
                                                    header("location: /filmStudio/actor_agent/find_movie.php");
                                                      break;

                                                      case 'filmCrew':
                                                      header("location: /filmStudio/actor_agent/find_filmCrew.php");
                                                        break;

                                                        case 'editCrew':
                                                        header("location: /filmStudio/actor_agent/find_editCrew.php");
                                                          break;
