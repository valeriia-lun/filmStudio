...
if (isset($_POST['find'])){
  ...
  switch ($choice) {
    case 'actor':
      header("location: /filmStudio/sound_director/find_actors.php");
      break;

    case 'understudy':
      header("location: /filmStudio/sound_director/find_understudies.php");
      break;

    case 'others':
    header("location: /filmStudio/sound_director/find_others.php");
      break;
                                            ...
                                            header("location: /filmStudio/sound_director/find_others.php");
                                              ...
                                              header("location: /filmStudio/sound_director/find_others.php");
                                                ...
                                                header("location: /filmStudio/sound_director/find_others.php");
                                                  ...
                                                  case 'editor':
                                                  header("location: /filmStudio/sound_director/find_editor.php");
                                                    break;

                                                    case 'movie':
                                                    header("location: /filmStudio/sound_director/find_movie.php");
                                                      break;

                                                      case 'filmCrew':
                                                      header("location: /filmStudio/sound_director/find_filmCrew.php");
                                                        break;

                                                        case 'editCrew':
                                                        header("location: /filmStudio/sound_director/find_editCrew.php");
                                                          break;
  }
}
