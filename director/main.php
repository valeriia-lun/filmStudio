...
<h3 class="colorText">Пошук</h3></br>
  ...
  <select name="choice" class="select selectpicker  form-control">
    ...
    <option value="editCrew">Монтажні групи</option></select><br>
<div class="btn">
...
if (isset($_POST['find'])){
  ...
  switch ($choice) {
    case 'actor':
    header("location: /filmStudio/director/find_actors.php");
      break;

    case 'understudy':
    header("location: /filmStudio/director/find_understudies.php");
      break;
                                            ...
                                            header("location: /filmStudio/director/find_others.php");
                                              ...
                                              header("location: /filmStudio/director/find_others.php");
                                                ...
                                                header("location: /filmStudio/director/find_others.php");
                                                  ...
                                                  case 'editor':
                                                    header("location: /filmStudio/director/find_editor.php");
                                                    break;
