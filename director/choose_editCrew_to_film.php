...
<select class="form-control" name="selecting">
...
while ($stroka = mysqli_fetch_array($result_edit_crews)){
    ...
    echo"<td>" ."<input type=\"checkbox\" class=\"form-control\" name=\"check2\"  value = \"" . $stroka['number_of_edit_crew'] . "\" onclick=\"onlyOne(this)\" >";
    echo"</tr>";
   }
...
<div class="btn noprint">
<form><button class ="button btn btn-danger" name="done">Обрати</button></form></div>
</body>
</html>
