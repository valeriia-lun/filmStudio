...
while ($stroka = mysqli_fetch_array($result_movies)){
  ...
  //  echo"<form action=\"editingMovie.php\" method=\"post\>";
    ...
    echo "<td>"."<div class = \"noprint\">"."<form  action = \"choose_filmCrew_to_film.php\" method=\"post\"><button value = \"" .$stroka['name_of_movie'] . "\" name=\"name_of_movie\">Обрати</button></form>"."</div></td>";
