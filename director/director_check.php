...
if ( $check1 != '') {
        ...
        if ($result) {
          echo "</br></br></br><h1 class=\"colorForAllText\">Знімальну групу успішно призначено на фільм!</h1>";
         }
      else {
        echo "</br></br></br><h1 class=\"colorForAllText\">Здається, щось пішло не так,групу монтажерів не було призначено..</h1>";
    ...
    if ($result) {
      echo "</br></br></br><h1 class=\"colorForAllText\">Групу монтажерів успішно призначено на фільм!</h1>";
     }
  else {
    echo "</br></br></br><h1 class=\"colorForAllText\">Здається, щось пішло не так,групу монтажерів не було призначено..</h1>";
    echo "<script><a href=\"#\"  class=\"btn btn-danger\" onclick=\"history.back();return false;\">Назад</a></script>";
  ...
  echo "</br></br></br><h1 class=\"colorForAllText\">Ви не обрали жодної групи!</h1>";
